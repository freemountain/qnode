...
QJSValue ModuleLoader::getCacheProp() {
...
QJSValue ModuleLoader::loadAsDirectory(QString path) {
    ...
    if(QFileInfo(path + "/index.js").isFile())
        return JSValueUtils::loadModule(this->engine, this->jsLoader, path + "/index.js");
...
QJSValue ModuleLoader::returnModule(QJSValue module, QString path) {
    if(!module.isError()) addCache(path, module);
...
QJSValue ModuleLoader::getJSValue() {
