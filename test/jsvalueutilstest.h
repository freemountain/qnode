...
private Q_SLOTS:
    ...
    void testStringify_data() {
        ...
        //QTest::newRow("function") << "var f = function f(){}; return {f:f};" << "[Function: f]";
        //QTest::newRow("function") << "return function(){};" << "[Function]";
        QTest::newRow("undefined") << "return undefined;" << "undefined";
        QTest::newRow("null") << "return null;" << "null";
        QTest::newRow("integer") << "return 3;" << "3";
        QTest::newRow("float") << "return 0.1;" << "0.1";
        QTest::newRow("string") << "return \"dsd\";" << "\"dsd\"";
        QTest::newRow("boolean") << "return true;" << "true";
        QTest::newRow("boolean") << "return false;" << "false";
        QTest::newRow("empty object") << "return {};" << "{}";
        QTest::newRow("simple object") << "return {n: 1};" << "{n: 1}";
        QTest::newRow("nested object") << "return {f: 1.1, 'o': {'d': 5}};" << "{f: 1.1, o: {d: 5}}";

        QTest::newRow("empty array") << "return [];" << "[]";


        QTest::newRow("nested array") << "return [1, [true, false]];" << "[1, [true, false]]";
        QTest::newRow("simple array")
                << " return[0, true, 'hi', 9.8];"
                << "[0, true, \"hi\", 9.8]";
        ...
        QTest::newRow("object")
                << "return {foo: 'bar', z: 4.6, a: []};"
                << "{a: [], foo: \"bar\", z: 4.6}";

        QTest::newRow("error")
                << "var a = new Error(); return a;"
                << "{}";
    }
    ...
    void testArraytoList() {
        QJSValue a = JSValueUtils::createValue(this->engine, "var a = [{},true,3];"
                                                             "a[4] = 'last'; return a;");
    ...
    void testCreateError() {
        QJSValue error = JSValueUtils::createError(this->engine, "my msg", "['myStack']");
